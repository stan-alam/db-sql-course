...
SELECT TOP (1000) [EmployeeID]
  ...
  --------
  --16
  select Country from AdventureWorks.dbo.Customers Group By Country
  --17
  --contact titles for customers
  -- discuss 
  select ContactTitle, TotalContactTitle = count(*) from AdventureWorks.dbo.Customers Group By ContactTitle Order By count(*) desc